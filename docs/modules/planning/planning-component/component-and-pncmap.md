---
title: "planning_component 与 pnc_map 函数级源码剖析"
---
...
- 本文与 [Planning 模块总览](../index.md) 与 [Decision 模块](../scenarios/decision.md) 构成完整的 Planning 技术栈文档。
:::
...
位置：`modules/planning/planning_base/reference_line/reference_line_provider.h/cc`。完整文档请参阅 [参考线提供者](../planning-base/reference-line.md)，此处只梳理它与 PncMap 的接口。
...
- [Decision 模块](../scenarios/decision.md)
